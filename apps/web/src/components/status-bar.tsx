      ...
      <div className="flex items-center justify-between px-6 py-2 text-xs uppercase tracking-widest">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-terminal-green">NET_UPLINK</span>
          </div>
          <div className="text-muted-foreground">
            UPTIME: <span className="text-foreground">{formatUptime(uptime)}</span>
          </div>
          <div className="text-muted-foreground">
            LATENCY: <span className="text-terminal-green">{latency}ms</span>
          </div>
        </div>
        <div className="text-muted-foreground">
          CERTIFIED: <span className="text-terminal-green">1,337</span>
        </div>
      </div>
    </div>
  )
